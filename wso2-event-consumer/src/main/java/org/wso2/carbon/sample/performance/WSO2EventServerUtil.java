...
public class WSO2EventServerUtil {
    ...
    public static void setCepHome(String cepHome) {
        WSO2EventServerUtil.cepHome = cepHome;
        securityFile = new File(cepHome + File.separator
    ...
    public static String getDataBridgeConfigPath() throws URISyntaxException {
//        return new File("src" + File.separator + "main" + File.separator + "resources"
//                + File.separator + "data-bridge-config.xml").getAbsolutePath();
        URL resource = WSO2EventServerUtil.class.getClassLoader().getResource("data-bridge-config.xml");
        return new File(resource.toURI()).getAbsolutePath();
    }

    public static StreamDefinition loadStream(int noOfFeatures) {
//        File fileEntry = new File("src" + File.separator + "main" + File.separator + "resources" + File.separator
//                + "org.wso2.event.prediction.500.stream_1.0.0.json").getAbsoluteFile();
        File fileEntry = new File(configDirectoryPath + File.separator
                + "org.wso2.event.prediction." + noOfFeatures + ".stream_1.0.0.json").getAbsoluteFile();
